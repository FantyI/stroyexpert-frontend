    ...
    return (
        <div className={s.login} >
            <div className={s.wrap}>
                ...
                <button onClick={login} className={s.sign}>Sign in</button>
                <div className={s.or}>
                    <hr />
                    or
                    <hr />
                ...
                <p className={s.register}>Already have an account?? <Link className={s.link} to='/auth/register'>Create on</Link></p>
            </div>
